...
namespace NotificationCenter.Migrations
{
    ...
    [Migration("20180819004730_RefactoringGroups")]
    partial class RefactoringGroups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotificationCenter.Models.SubscriptionGroups", b =>
                {
                    b.Property<int>("NotificationGroupId");

                    b.Property<int>("SubscriptionId");

                    b.HasKey("NotificationGroupId", "SubscriptionId");
            ...
            modelBuilder.Entity("NotificationCenter.Models.NotificationTags", b =>
                {
                    b.HasOne("NotificationCenter.Models.Notification", "Notification")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("NotificationCenter.Models.SubscriptionGroups", b =>
                {
                    b.HasOne("NotificationCenter.Models.Tag", "NotificationGroup")
                        .WithMany("SubscriptionGroups")
                        .HasForeignKey("NotificationGroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NotificationCenter.Models.Subscription", "Subscription")
                        .WithMany("SubscriptionGroups")
